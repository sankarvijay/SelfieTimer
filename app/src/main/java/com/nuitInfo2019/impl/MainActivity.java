...
import com.nuitInfo2019.util.ARManager;
import com.nuitInfo2019.util.AndroidUtils;
import com.nuitInfo2019.util.CameraUtils;
import com.nuitInfo2019.util.ShutterButton;
import com.nuitInfo2019.util.ShutterButton.OnShutterButtonListener;
...
public class MainActivity extends Activity implements Camera.PictureCallback, Camera.AutoFocusCallback, OnShutterButtonListener {
    ...
    public void savePictureNow() {
		...
		statusTextField.setText("Photos prises...");
